    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <div class='alert alert-success alert-dismissible fade in' role='alert' style='border-radius:0px; margin-bottom:0px'>
          ...
          <a href="#" style="margin-right:10px; text-decoration:none;">Apa, Anda masih belum puas dengan versi free? Yuk mari beralih ke versi lebih keren dan lebih lengkap disini : </a>
